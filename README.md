...
![Time of MQTT messages measured in the ESP]("images/latency_esp")
![Time of MQTT messages measured in Python]("images/latency_py")
...
![Wireshark capture]("images/wireshark")
...
![The circuit("images/circuit")
![The circuit I built]("images/my_circuit")
